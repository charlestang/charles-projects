...
return array(
	...
	// abre con la aplicaci�n por defecto para esa tipo de ficheros
	...
	// En la visualizaci�n de los permisos de ficheros y directorios,
	// define si se ense�a en formato num�rico "775" = true
	...
	// Permite marcar si los usuarios de una ra�z recibir�n avisos al
	...
	// Tiempo durante el que se mantienen los registros estad�sticos de usuarios
	// Time during is mantained the users stats
	'logs_usuarios' => 1, // En Meses / In Mounths

	// Columnas que se ense�aran en los listados
	...
	// Permisos para la realizacion de acciones, o visulazaci�n de
	...
	'permisos' => array(
		...
		'novo_arq' => true, // Edit
		'redimensionar' => true, // Create thumbnails
		'redimensionar_dir' => true, // Create thumbnails with all images in a folder
		'redimensionar_dir_accion' => true, // If redimensionar_dir is true this must be true
		...
		'correo' => true, // Env�o de ficheros por correo / Send a file in a mail
		...
		'arbore' => true, // Directories tree // �rbol de directorios
		'ver_imaxes' => true, // Thumbnails preview // Previsualizar im�genes
		'axuda' => true, // Help option / Opci�n de ayuda
		'sair' => true, // Exit option / Opci�n de salir
	),
