...
<h3><span><?php comment_form_title( __('Leave a comment'), __('Leave a comment for %s' ) ); ?></span></h3>
...
<?php else : ?>
	...
	<div class="author"><?php if ($req) _e("*"); ?><?php _e('Name'); ?></div>
		<input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
	<div class="clear"></div>
	<div class="email"><?php if ($req) _e("*"); ?><?php _e('Mail'); ?></div>
...
<!--<p><small><?php printf(__('<strong>XHTML:</strong> You can use these tags: <code>%s</code>'), allowed_tags()); ?></small></p>-->
	...
	<div class="comment"><?php _e('Comment'); ?></div>
		<textarea name="comment" id="comment" cols="58" rows="8" tabindex="4"></textarea>
