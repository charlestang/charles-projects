...
*
* Procesa y devuelve los datos de los ficheros de informaci�n adicional
*
...
* class PFN_INC
*
* clase para tratamiento de informaci�n adicional
...
class PFN_INC {
	...
	*
	* recibe el objecto $PFN_conf con los parametros de configuraci�n
	...
	*
	* devuelve el posible nombre del archivo de informaci�n adicional
	*
	* return string
	*/
	...
	*
	* Devuelve los datos cargados de un fichero de informaci�n adicional
	*
	* return array
	*/
	function get_datos () {
	...
	*
	* a�ade mas campos o var�a los ya cargados con carga_datos()
	*/
	...
	*
	* devuelve el valor de un campo de informaci�n adicional
	*
	* return string
	*/
	...
	*
	* configura la recepci�n de datos desde el formulario como
	* m�ltiple (subida m�ltiple de ficheros) y a�ade una extensi�n
	...
	*
	* crea el texto para ense�ar en la pantalla de navegaci�n
	...
	* del archivo de informaci�n adicional para crear
	* un formulario con los campos necesarios.
	* simpre cargar� los campos datos por $this->conf->g('inc','comun')
	* y despues los necesarios seg�n el parametro
	* $tipo ('dir','arq') para completar el formulario
	*
	* cuando se usan varios ficheros de configuraci�n, solo se mostrar�n
			...
			foreach (array('comun',$tipo) as $lista) {
				foreach ($this->conf->g('inc',$lista) as $v) {
					if (is_callable(array($this, $v['tipo']))) {
						...
						// Llamada a la funci�n que genera el html para textarea o text
						$this->$v['tipo']($i,$v);
						$i++;
					}
				}
	...
	* del fichero de informaci�n adicional, el parametro
	...
	*
	* crea o modifica un fichero de informaci�n adicional pero manteniendo
	* los valores de otros campos ya existentes en caso de existir
	* solo modificar� los valores definidos por $this->conf->g('inc','comun')
